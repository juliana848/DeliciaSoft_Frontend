    ...
    const fetchProductos = async () => {
      try {
        ...
        const productosArray = Array.isArray(json)
          ? json.filter((producto) => {
              const categoria = (producto.categoria || producto.categoriaproducto?.nombrecategoria || "").toLowerCase();
              return categoria.includes("sandwich"); // así cubres "sandwich", "sanduches", etc.
            })
          : [
              {
